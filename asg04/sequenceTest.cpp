...
#include "sequence.h"
using namespace std;
namespace seqOfItem = CS3358ssII15Assign04_sequenceOfItem;
using namespace seqOfItem;
...
void show_list(seqOfItem::sequence<double> src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
void show_list(seqOfItem::sequence<char> src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
int get_object_num();
// Pre:  (none)
